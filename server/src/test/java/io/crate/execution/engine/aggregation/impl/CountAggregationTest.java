...
public class CountAggregationTest extends AggregationTestCase {
    ...
    private void test_count_on_object_with_not_null_immediate_child(DataType<?> childType, Class<?> expectedAggregatorClass) {
    ...
    @Test
    public void test_count_on_object_with_not_null_immediate_child() {
        ...
        for (var e : countedObjectToExpectedAggregatorMap.entrySet()) {
            test_count_on_object_with_not_null_immediate_child(e.getKey(), e.getValue());
        }
    }

    @Test
    public void test_count_on_object_with_not_null_grand_child() {
        ...
        Reference immediateChild = new Reference(
            new ReferenceIdent(null, new ColumnIdent("second_level_object")),
            RowGranularity.DOC,
    ...
    @Test
    public void test_count_on_object_with_not_null_sibling() {
    ...
    @Test
    public void test_count_on_object_with_not_null_siblings_child() {
    ...
    @Test
    public void test_count_on_object_with_nullable_child() {
